...
let
  ...
  renderServer =
    server:
    "    server ${server.name} ${server.address}:${toString server.port}${
          optionalString (server.options != "") " ${server.options}"
        }";
  ...
  renderService =
    ...
    ''
      frontend ${name}
        ...
        mode ${service.mode}
      ${optionalString (service.frontendConfig != "") (
      ...
      backend ${backendName}
        mode ${service.mode}
      ${optionalString (service.backendConfig != "") (
